const translations = {
  es: {
    ...
    "continental_title": "Contador de Continental",
    "continental_desc": "Anota los puntos de tus partidas de Continental sin conexión.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "Simulador de la Copa del Mundo 2026: crea y comparte tu propio cuadro.",
    "star_title": "Star & Hero Realms Contador",
    "star_desc": "Contador de puntos, vida y autoridad para Star Realms y Hero Realms.",
    "chinchon_title": "Contador Chinchón de Puntos",
  ...
  en: {
    ...
    "continental_title": "Continental Counter",
    "continental_desc": "Keep track of your Continental card game scores offline.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "2026 World Cup simulator: create and share your own bracket.",
  ...
  fr: {
    ...
    "continental_title": "Compteur de Continental",
    "continental_desc": "Notez les points de vos parties de Continental hors ligne.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "Simulateur de la Coupe du Monde 2026 : créez et partagez votre propre tableau.",
  ...
  de: {
    ...
    "continental_title": "Continental Zähler",
    "continental_desc": "Notieren Sie die Punkte Ihrer Continental-Kartenspiele offline.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "Weltmeisterschaft 2026 Simulator: Erstellen und teilen Sie Ihren eigenen Spielplan.",
  ...
  it: {
    ...
    "continental_title": "Contatore Continental",
    "continental_desc": "Segna i punti delle tue partite di Continental offline.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "Simulatore della Coppa del Mondo 2026: crea e condividi il tuo tabellone.",
  ...
  pt: {
    ...
    "continental_title": "Contador de Continental",
    "continental_desc": "Anote os pontos de suas partidas de Continental offline.",
    "world_cup_title": "World Cup 2026 Predictor",
    "world_cup_desc": "Simulador da Copa do Mundo 2026: crie e compartilhe sua própria tabela.",
